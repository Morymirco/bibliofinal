            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div class="max-w-[570px] mb-12 lg:mb-0">
                ...
                <p class="text-base text-body-color leading-relaxed mb-9">
                  ...
                  contacter pour toute assistance supplémentaire concernant nos
                  services de bibliothèque en ligne. Notre équipe dévouée est
                  disponible pour répondre à toutes vos questions et vous
                  fournir le soutien dont vous avez besoin
                </p>
              </div>
            </div>
