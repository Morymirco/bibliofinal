...
export default function Homepage() {
  ...
  <h1 className="text-3xl font-bold text-gray-800 mb-8">Catégories de livres</h1>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <a href="/frontend-performance"
        ...
        Cette catégorie comprend des œuvres de fiction, y compris des romans contemporains, classiques, historiques, de science-fiction, de fantasy, de romance, de suspense, etc. Les lecteurs peuvent explorer différents genres et styles d'écriture.
        </span>
      </a>
      <a href="/api-security"
        class="relative flex h-full flex-col rounded-md border border-gray-200 bg-white p-2.5 hover:border-gray-400 sm:rounded-lg sm:p-5">
        ...
        <span class="text-sm leading-normal text-gray-400 sm:block">
        Cette catégorie propose des livres sur le bien-être, la croissance personnelle, la psychologie positive, la gestion du temps, le leadership, la motivation, la santé mentale, la spiritualité, etc. Les lecteurs peuvent trouver des conseils et des outils pour améliorer leur vie.
        </span>
      </a>
      <a href="/code-review"
        class="relative flex h-full flex-col rounded-md border border-gray-200 bg-white p-2.5 hover:border-gray-400 sm:rounded-lg sm:p-5">
        ...
        <span class="text-sm leading-normal text-gray-400 sm:block">
        Cette catégorie regroupe les livres sur l'histoire mondiale, les civilisations anciennes, les événements historiques, les biographies historiques, les cultures, les traditions, les religions, les coutumes, etc. Les lecteurs peuvent enrichir leur compréhension du passé et des diverses cultures.
        </span>
      </a>
      <a href="/aws"
        class="relative flex h-full flex-col rounded-md border border-gray-200 bg-white p-2.5 hover:border-gray-400 sm:rounded-lg sm:p-5">
        ...
        <span class="text-sm leading-normal text-gray-400 sm:block">
        Cette catégorie est dédiée aux livres pour enfants et adolescents, y compris les livres illustrés, les contes, les romans jeunesse, les albums, les livres éducatifs, les livres audio, etc. Elle vise à stimuler l'imagination et l'apprentissage chez les jeunes lecteurs.
        </span>
      </a>
    </div>
  </div>
  <div>
            ...
            <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40 border mt-2">
                <CarouselProvider naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={2}>
                    ...
                    <h1 className="text-5xl font-bold xl:hidden block leading-tight lg:leading-10 text-gray-800">Ce que disent nos lecteurs</h1>
                    <Slider>
                        <Slide index={0} tabIndex="null">
                            <div className="flex">
                                <div className="mt-14 md:flex">
                                    <div className="relative lg:w-1/2 sm:w-96 xl:h-96 h-80">
                                        <img src="./te.jpg" alt="image of profile" className="w-full h-full flex-shrink-0 object-fit object-cover shadow-lg rounded" />
  ...
  <div class="w-full max-w-full px-3 mb-6  mx-auto container">
    <div class="relative flex-[1_auto] flex flex-col break-words min-w-0 bg-clip-border rounded-[.95rem] border border-dashed border-stone-200 bg-white m-5">
      ...
      <div class="flex-auto block py-8 px-9">
        <div>
          <div class="mb-9">
            <h1 class="mb-2 text-[1.75rem] font-semibold text-dark">Notre équipe de développement </h1>
            <span class="text-[1.15rem] font-medium text-muted"> Rencontrez notre équipe talentueuse, un groupe dynamique d’experts animés par la passion et l’innovation.</span>
          </div>
          <div class="flex flex-wrap w-full">
            <div class="flex flex-col mr-5 text-center mb-11 lg:mr-16">
              <div class="inline-block mb-4 relative shrink-0 rounded-[.95rem]">
                <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]" src="https://dev-geniusclass2.pantheonsite.io/wp-content/uploads/2024/04/IMG_1472-scaled.jpeg" alt="avarat image"/>
              </div>
              <div class="text-center">
                <a href="javascript:void(0)" class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Mory koulibaly</a>
