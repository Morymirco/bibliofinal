    ...
    <div><div
      ...
      <div class="w-full max-w-md bg-white shadow-lg rounded-md p-6 relative">
        <div class="flex items-center pb-3 border-b">
          <h3 class="text-xl font-bold flex-1 text-[#333]">Partager le livre </h3>
         <button onClick={handleshowmodal}>
         <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 cursor-pointer shrink-0 fill-black hover:fill-red-500"
        ...
        <div class="my-8">
          <h6 class="text-base text-[#333]">Partager avec ses liens</h6>
          <div class="space-x-6 mt-6 text-center">
            <button type="button"
              class="w-12 h-12 inline-flex items-center justify-center rounded-full border-none outline-none bg-blue-600 hover:bg-blue-700 active:bg-blue-600">
            ...
            <button type="button"
              class="w-12 h-12 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#03a9f4] hover:bg-[#03a1f4] active:bg-[#03a9f4]">
            ...
            <button type="button"
              class="w-12 h-12 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#0077b5] hover:bg-[#0055b5] active:bg-[#0077b5]">
            ...
            <button type="button"
              class="w-12 h-12 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#ea0065] hover:bg-[#ea0065d6] active:bg-[#ea0065]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="#fff" viewBox="0 0 512 512">
        ...
        <div>
          <h6 class="text-base text-[#333]">ou copier le lien</h6>
          <div class="w-full rounded overflow-hidden border flex items-center mt-6">
            <p class="text-sm text-gray-400 flex-1 ml-4">https://readymadeui.com/</p>
            <button class="bg-blue-500 hover:bg-blue-600 px-4 py-3 text-sm text-white">Copier</button>
          </div>
        </div>
      </div>
    </div></div>
